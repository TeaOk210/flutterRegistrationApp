...
class AuthRepository implements AuthMethods {
 @override
 Stream<AuthResult> registerUsingEmail({required String email, required String password, required String username}) async* {
 ...
 @override
 Stream<AuthResult> signInWithEmail({required String email, required String password}) async* {
     FirebaseAuth auth = FirebaseAuth.instance;
   User? user;
   try {
